...
export default function Hero() {
  return (
    <section className="bg-gradientHero ">
      <div className=" relative max-w-screen-2xl mx-auto   pt-24  flex flex-col lg:grid grid-cols-2 overflow-hidden  ">
        <div className=" flex flex-col gap-4 pt-12 pb-16 pl-14 ">
          <h1 className="text-[5.625rem] font-fauBold font-bold leading-[6.1875rem] bg-image">
            Your design team for the cost
            <br /> of a salary.
          </h1>
        ...
        <div className="  absolute lg:-right-32 -bottom-28">
